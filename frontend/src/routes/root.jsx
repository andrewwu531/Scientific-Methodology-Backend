...
export default function Root() {
  return (
    <div className="h-screen bg-black-2">
      ...
      <div className="relative z-10 h-[91vh] min-w-[50rem] grid overflow-hidden grid-cols-[min-content_auto] gap-y-2 p-2 bg-black-2">
        <Sidebar />
         ...
         <aside className="flex items-center justify-between col-span-2 px-4 py-3 bg-gradient-to-r from-accent-1 to-accent-2">
            <p className="pl-3">
              <span className="block text-base tracking-wider ">
                We are M. Our mission is to provide everyone the highest quality courses possible in the world!
              </span>
