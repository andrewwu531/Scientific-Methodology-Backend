  ...
  return (
    <SectionContainer>
      {/* <div className="relative flex items-center justify-between px-4 py-4 shadow-lg shadow-neutral-950">
        <RoundedButton className="flex items-center gap-3 px-2 py-1 transition-colors duration-300 text-neutral-400 hover:text-neutral-100 ">
          <FontAwesomeIcon icon={faListDots} />
          Your Library
        </RoundedButton>

        <CircularButton className="w-8 transition-colors hover:bg-neutral-800 text-neutral-400 hover:text-neutral-100 ">
      ...
      <div className="flex flex-col overflow-auto h-[70vh] scrollbar-thin scrollbar-thumb-rounded scrollbar-thumb-gray-800 scrollbar-thumb-hover-gray-600">
        <VerticalCard className="flex flex-col items-start justify-start gap-3 p-3.5 pb-5 rounded-lg bg-black-1">
          <p className="pt-2 pb-1 pl-2 text-base font-bold text-white text-sans">
          ...
          <p className="pt-5 pb-1 pl-2 text-base font-bold text-white">
            Health & Lifestyle
          </p>
          <div className="flex flex-wrap gap-2.5">
            <SecondaryButton className="px-4 py-2 pt-2.5 text-tiny text-neutral-100  text-sans font-regular">
      ...
      <div className="bg-neutral-900 flex flex-col items-start justify-center px-5 h-[9vh]">
        <ul className="flex flex-wrap text-[0.9rem] text-neutral-400 gap-3">
          ...
          <li>
            <FlatButton href="#">Privacy</FlatButton>
          </li>
        </ul>
      </div>
    </SectionContainer>
