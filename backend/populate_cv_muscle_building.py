...
def populate():
    # Define data for courses and their associated videos
    ...
    #             },
    #             {
    #                 'video_title': 'Effective Workout Routines',
    #                 'video_subscription_type': Videos.Video_Subscription_Type.FREE,
    #                 'video_series_name': 'Workout Series',
    #                 'video_series': '1',
    #                 'video_episode': '2',
    #                 'video_icon': 'Muscle_Building/Video_Icon/Muscle_Building_Video_Icon_3.jpg',
    #                 'video_video': 'Muscle_Building/Video_Video/Muscle_Building_Video_Video_2.mp4',
    #                 'video_essay': 'Best practices for effective workouts.'
    #             }
    #         ]
    #     }
    # }

    # Populate the courses and their associated videos
